...
[_QW] = { /* Qwerty */
  {KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,   KC_GRV,   KC_Y,    KC_U,    KC_I,    KC_O,    KC_P    },
  {KC_A,    KC_S,    KC_D,    KC_F,    KC_G,   KC_BSLS,  KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN },
 ...
 */
[_RS] = { /* [> RAISE <] */
  {KC_EXLM, KC_AT,   KC_UP,   KC_DLR,  KC_PERC, KC_CIRC, KC_PGUP, KC_7,    KC_8,   KC_9, KC_BSPC},
  {KC_LPRN, KC_LEFT, KC_DOWN, KC_RGHT, KC_RPRN, KC_AMPR, KC_PGDN, KC_4,    KC_5,   KC_6, KC_BSLS},
  {KC_LBRC, KC_RBRC, KC_HASH, KC_LBRC, KC_RBRC, KC_LCTL, KC_ASTR, KC_1,    KC_2,   KC_3, KC_PLUS},
